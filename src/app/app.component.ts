...
export class AppComponent {
  ...
  hards = [
    'HTML - 3 anos', 'CSS - 3 anos', 'SASS - 2,5 anos', 'Bootstrap - 2 anos', 'Tailwind - 1,5 anos', 'Javascript - 3 anos', 'ReactJS - 1 ano', 'PHP - 3 anos', 'Laravel - 3 anos', 'Lumen - 3 anos', 'SQL - 3 anos', 'MYSQL - 3 anos', 'GIT - 3 anos', 'GitLab - 3 anos', 'GitHub - 3 anos'
  ];
  courses = [
